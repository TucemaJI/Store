...
export const getPESuccess = createAction(EPrintingEditionActions.GetPESuccess, props<{ minPrice: number, maxPrice: number, pageParameters: IPageParameters, printingEditions: IPrintingEdition[] }>());
